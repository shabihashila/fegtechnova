...
class Cron{
	...
	static function check_geo_db_update(){
		global $cookieadmin;
		...
		$latest_filename = \CookieAdminPro\Admin\Geo::check_for_db_update_available();
		...
		$current_filename = !empty($db_data['filename']) ? $db_data['filename'] : '';
		...
		update_option('cookieadmin_pro_geo_db_update_available', [
