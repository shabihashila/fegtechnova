	...
	static function override_gpc($html){
		...
		if(cookieadmin_is_multilingual_active()){
			if(cookieadmin_is_polylang_active()){
				...
				$gpc_override_warning = apply_filters( 'wpml_translate_single_string', $gpc_override_warning, 'CookieAdmin', 'gpc_override_warning');
			}
		}
	...
	static function toast($template){
		...
		if(cookieadmin_is_multilingual_active()){
			if(cookieadmin_is_polylang_active()){
				...
				$gpc_message = apply_filters( 'wpml_translate_single_string', $gpc_message, 'CookieAdmin', 'gpc_message');
			}
		}
