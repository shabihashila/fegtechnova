...
class Admin{
	...
	static function enqueue_scripts(){
		...
		// Load free plugin styles on Geo Targeting page since it relies on the base design system
		if($current_page === 'cookieadmin-geo-targeting'){
		...
		// Geo Targeting page assets
		if($current_page === 'cookieadmin-geo-targeting'){
			wp_enqueue_script('cookieadmin-geo-js', COOKIEADMIN_PRO_PLUGIN_URL . 'assets/js/geo.js', ['jquery'], COOKIEADMIN_PRO_VERSION, true);
			wp_enqueue_style('cookieadmin-geo-css', COOKIEADMIN_PRO_PLUGIN_URL . 'assets/css/geo.css', [], COOKIEADMIN_PRO_VERSION);
			
			$locations = include(COOKIEADMIN_PRO_DIR . 'lib/locations.php');
			$geo_vars = [
				'ajax_url' => admin_url('admin-ajax.php'),
				'nonce' => wp_create_nonce('cookieadmin_pro_admin_js_nonce'),
				...
				'lang' => [
					'table_title' => __('Geo Targeting Rules', 'cookieadmin'),
					'rule_name' => __('Rule Name', 'cookieadmin'),
					'law_type' => __('Law Type', 'cookieadmin'),
					'select_law' => __('Select Law Type', 'cookieadmin'),
					'countries' => __('Countries', 'cookieadmin'),
					'add_country' => __('+ Add Country', 'cookieadmin'),
					'remove_country' => __('Remove', 'cookieadmin'),
					'block_scripts' => __('Block Scripts', 'cookieadmin'),
					'block_scripts_short' => __('Scripts', 'cookieadmin'),
					'content_blocking' => __('Content Blocking', 'cookieadmin'),
					'content_blocking_short' => __('Content', 'cookieadmin'),
					'google_consent_mode' => __('Google Consent Mode', 'cookieadmin'),
					'google_consent_mode_short' => __('Google', 'cookieadmin'),
					'clarity_consent' => __('Clarity Consent', 'cookieadmin'),
					'clarity_consent_short' => __('Clarity', 'cookieadmin'),
					'inherit' => __('Inherit', 'cookieadmin'),
					'on' => __('On', 'cookieadmin'),
					'off' => __('Off', 'cookieadmin'),
					'edit' => __('Edit', 'cookieadmin'),
					'delete' => __('Delete', 'cookieadmin'),
					'delete_rule' => __('Delete Rule', 'cookieadmin'),
					'saving' => __('Saving...', 'cookieadmin'),
					'saved' => __('Settings saved successfully', 'cookieadmin'),
					'save_error' => __('Failed to save. Please try again.', 'cookieadmin'),
					'rule_saved' => __('Rule saved', 'cookieadmin'),
					'name_required' => __('Rule name is required', 'cookieadmin'),
					'law_required' => __('Law type is required', 'cookieadmin'),
					'countries_required' => __('At least one country is required', 'cookieadmin'),
					'delete_confirm' => __('Are you sure you want to delete this rule?', 'cookieadmin'),
					'shortcut_exists' => __('This shortcut is already added', 'cookieadmin'),
					'shortcut_added' => __('shortcut added', 'cookieadmin'),
					'remove_shortcut' => __('Remove shortcut', 'cookieadmin'),
					'country_singular' => __('country', 'cookieadmin'),
					'country_plural' => __('countries', 'cookieadmin'),
					'gdpr_preset_name' => __('GDPR Countries', 'cookieadmin'),
					'us_preset_name' => __('US State Laws', 'cookieadmin'),
					'shortcuts_label' => __('Shortcuts', 'cookieadmin'),
					'shortcut_eu' => __('EU', 'cookieadmin'),
					'shortcut_eea' => __('EEA', 'cookieadmin'),
					'shortcut_africa' => __('Africa', 'cookieadmin'),
					'shortcut_asia' => __('Asia', 'cookieadmin'),
					'shortcut_europe' => __('Europe', 'cookieadmin'),
					'shortcut_north_america' => __('North America', 'cookieadmin'),
					'shortcut_south_america' => __('South America', 'cookieadmin'),
					'shortcut_oceania' => __('Oceania', 'cookieadmin'),
					'shortcut_caribbean' => __('Caribbean', 'cookieadmin'),
					'shortcut_asean' => __('ASEAN', 'cookieadmin'),
					'shortcut_worldwide' => __('Worldwide', 'cookieadmin'),
					'toggle_error' => __('Failed to update setting', 'cookieadmin'),
					'rule_singular' => __('rule', 'cookieadmin'),
					'rule_plural' => __('rules', 'cookieadmin'),
				],
			];
			wp_localize_script('cookieadmin-geo-js', 'cookieadmin_geo_vars', $geo_vars);
		}
	...
	static function add_cookie(){
		...
		$patterns = '[]';
		$csv_matches = cookieadmin_load_cookies_csv([$cookie_info['name']], 0);
		if(!empty($csv_matches) && !is_wp_error($csv_matches)){
			foreach($csv_matches as $match){
				if(isset($match['cookie_name']) && $match['cookie_name'] === $cookie_info['name']){
					$patterns = isset($match['patterns']) ? $match['patterns'] : '[]';
					break;
				}
			}
		}
